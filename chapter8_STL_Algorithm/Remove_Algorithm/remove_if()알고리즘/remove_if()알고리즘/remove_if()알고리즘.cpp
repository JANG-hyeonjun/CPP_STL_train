// remove_if()알고리즘.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
//	vec.emplace_back(30);
	...
	std::vector<int>::iterator iter_end = vec.erase(std::remove_if(vec.begin(), vec.end(), Pred),vec.end());
